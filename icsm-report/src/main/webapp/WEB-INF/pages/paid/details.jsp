...
<script type="text/javascript">
        $(document).ready(function(){
             $.getJSON('${ctx}/api/paid/byId?appId=${appId}&hours=${hours}&lookBackHours=${lookBackHours}', function(data)
                     {
                 var ranking = "";
                 var headline = "";
...
<h1>Paid Chart Details</h1>
<p><a href="${ctx}/app/campaign_report_paid?hours=${hours}"><span class="back"><</span> BACK</a></p>
